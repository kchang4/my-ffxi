...
zones[xi.zone.CAEDARVA_MIRE] =
{
    text =
    {
        ...
        STAGING_GATE_AZOUPH           = 7326, -- Azouph Isle Staging Point.
        STAGING_GATE_DVUCCA           = 7329, -- Dvucca Isle Staging Point.
        ...
        JAZARAATS_HEADSTONE           = 7547, -- The name Sir Jazaraat is engraved on the headstone...
        SEAPRINCES_TOMBSTONE          = 8071, -- It appears to be the grave of a great soul to an age long past.
        SHED_LEAVES                   = 8077, -- The ground is strewn with shed leaves...
        SICKLY_SWEET                  = 8082, -- A sickly sweet fragrance pervades the air...
        STIFLING_STENCH               = 8088, -- A stifling stench pervades the air...
        SHREDDED_SCRAPS               = 8095, -- Shredded scraps of paper are scattered all over...
        DRAWS_NEAR                    = 8104, -- Something draws near!
        HOMEPOINT_SET                 = 8997, -- Home point set!
        UNITY_WANTED_BATTLE_INTERACT  = 9055, -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        COMMON_SENSE_SURVIVAL         = 9077, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
