...
{
    {
        { itemId = xi.item.GIL,                      weight = 1000, amount = 15000 },
    },

    {
        quantity = 3,
        { itemId = xi.item.UNDEAD_SKIN,              weight = 1000 },
    },

    {
        quantity = 2,
        { itemId = xi.item.MANA_CIRCLET,             weight = 62 },
        { itemId = xi.item.RIVAL_RIBBON,             weight = 62 },
        { itemId = xi.item.SHOCK_MASK,               weight = 62 },
        { itemId = xi.item.SUPER_RIBBON,             weight = 62 },
        { itemId = xi.item.IVORY_MITTS,              weight = 62 },
        { itemId = xi.item.RUSH_GLOVES,              weight = 62 },
        { itemId = xi.item.SLY_GAUNTLETS,            weight = 62 },
        { itemId = xi.item.SPIKED_FINGER_GAUNTLETS,  weight = 62 },
        { itemId = xi.item.ESOTERIC_MANTLE,          weight = 62 },
        { itemId = xi.item.HEAVY_MANTLE,             weight = 62 },
        { itemId = xi.item.SNIPERS_MANTLE,           weight = 62 },
        { itemId = xi.item.TEMPLARS_MANTLE,          weight = 62 },
        { itemId = xi.item.BENIGN_NECKLACE,          weight = 62 },
        { itemId = xi.item.HATEFUL_COLLAR,           weight = 62 },
        { itemId = xi.item.INTELLECT_TORQUE,         weight = 62 },
        { itemId = xi.item.STORM_GORGET,             weight = 62 },
    },
