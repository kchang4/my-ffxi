...
content.loot =
{
    ...
    {
        { itemId = xi.item.EVASION_TORQUE,         weight = 250 },
        { itemId = xi.item.NINJUTSU_TORQUE,        weight = 250 },
        { itemId = xi.item.PARRYING_TORQUE,        weight = 250 },
        { itemId = xi.item.SUMMONING_TORQUE,       weight = 250 },
    },
...

    {
        ...
        { itemId = xi.item.ELEMENTAL_TORQUE,       weight = 250 },
        { itemId = xi.item.ENHANCING_TORQUE,       weight = 250 },
        { itemId = xi.item.GUARDING_TORQUE,        weight = 250 },
    },
