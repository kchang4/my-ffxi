...
content.loot =
{
    ...
    {
        quantity = 3,
        { itemId = xi.item.ARCHALAUSS_POLE,         weight = 50 },
        { itemId = xi.item.ARAMISS_RAPIER,          weight = 50 },
        { itemId = xi.item.CHICKEN_KNIFE,           weight = 50 },
        { itemId = xi.item.DOMINION_MACE,           weight = 50 },
        { itemId = xi.item.DRAGVANDIL,              weight = 50 },
        { itemId = xi.item.FEY_WAND,                weight = 50 },
        { itemId = xi.item.FORSETIS_AXE,            weight = 50 },
        { itemId = xi.item.HAMELIN_FLUTE,           weight = 50 },
        { itemId = xi.item.KABRAKANS_AXE,           weight = 50 },
        { itemId = xi.item.SARNGA,                  weight = 50 },
        { itemId = xi.item.SPARTAN_CESTI,           weight = 50 },
        { itemId = xi.item.VASSAGOS_SCYTHE,         weight = 50 },
        { itemId = xi.item.ARMBRUST,                weight = 80 },
        { itemId = xi.item.LIGHT_BOOMERANG,         weight = 80 },
        { itemId = xi.item.OMOKAGE,                 weight = 80 },
        { itemId = xi.item.SAIREN,                  weight = 80 },
        { itemId = xi.item.SCHWARZ_LANCE,           weight = 80 },
    },

    {
        { itemId = xi.item.AQUAMARINE,              weight = 40 },
        { itemId = xi.item.CHRYSOBERYL,             weight = 40 },
        { itemId = xi.item.FLUORITE,                weight = 40 },
        { itemId = xi.item.JADEITE,                 weight = 40 },
        { itemId = xi.item.MOONSTONE,               weight = 40 },
        { itemId = xi.item.PAINITE,                 weight = 40 },
        { itemId = xi.item.SUNSTONE,                weight = 40 },
        { itemId = xi.item.ZIRCON,                  weight = 40 },
        { itemId = xi.item.BLACK_ROCK,              weight = 40 },
        { itemId = xi.item.BLUE_ROCK,               weight = 40 },
        { itemId = xi.item.GREEN_ROCK,              weight = 40 },
        { itemId = xi.item.PURPLE_ROCK,             weight = 40 },
        { itemId = xi.item.RED_ROCK,                weight = 40 },
        { itemId = xi.item.TRANSLUCENT_ROCK,        weight = 40 },
        { itemId = xi.item.WHITE_ROCK,              weight = 40 },
        { itemId = xi.item.YELLOW_ROCK,             weight = 40 },
        ...
        { itemId = xi.item.STEEL_INGOT,             weight = 40 },
        { itemId = xi.item.DEMON_HORN,              weight = 40 },
        { itemId = xi.item.CORAL_FRAGMENT,          weight = 40 },
        { itemId = xi.item.HI_RERAISER,             weight = 20 },
        { itemId = xi.item.VILE_ELIXIR_P1,          weight = 20 },
    },

    {
        { itemId = xi.item.SCROLL_OF_RERAISE_II,    weight = 250 },
        { itemId = xi.item.SCROLL_OF_FIRE_III,      weight = 250 },
        { itemId = xi.item.SCROLL_OF_CARNAGE_ELEGY, weight = 250 },
        { itemId = xi.item.ICE_SPIRIT_PACT,         weight = 250 },
    },

    {
        { itemId = xi.item.DEMON_SKULL,             weight = 1000 },
    },
}
