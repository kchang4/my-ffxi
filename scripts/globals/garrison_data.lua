...
xi.garrison.loot =
{
    [20] =
    {
        { item = xi.item.DRAGON_CHRONICLES, weight = 1000 },
        { item = xi.item.GARRISON_TUNICA,   weight =  350 },
        { item = xi.item.GARRISON_BOOTS,    weight =  350 },
        { item = xi.item.GARRISON_HOSE,     weight =  350 },
        { item = xi.item.GARRISON_GLOVES,   weight =  350 },
        { item = xi.item.GARRISON_SALLET,   weight =  350 },
    },
    [30] =
    {
        { item = xi.item.DRAGON_CHRONICLES, weight = 1000 },
        { item = xi.item.MILITARY_GUN,      weight =  350 },
        { item = xi.item.MILITARY_POLE,     weight =  350 },
        { item = xi.item.MILITARY_HARP,     weight =  350 },
        { item = xi.item.MILITARY_PICK,     weight =  350 },
        { item = xi.item.MILITARY_SPEAR,    weight =  350 },
        { item = xi.item.MILITARY_AXE,      weight =  350 },
    },
    [40] =
    {
        { item = xi.item.DRAGON_CHRONICLES, weight = 1000 },
        { item = xi.item.VARIABLE_MANTLE,   weight =  350 },
        { item = xi.item.VARIABLE_CAPE,     weight =  350 },
        { item = xi.item.PROTEAN_RING,      weight =  350 },
        { item = xi.item.VARIABLE_RING,     weight =  350 },
        { item = xi.item.MECURIAL_EARRING,  weight =  350 },
    },
    [50] =
    {
        { item = xi.item.DRAGON_CHRONICLES, weight = 1000 },
        { item = xi.item.UNDEAD_EARRING,    weight =  350 },
        { item = xi.item.ARCANA_EARRING,    weight =  350 },
        { item = xi.item.VERMIN_EARRING,    weight =  350 },
        { item = xi.item.BIRD_EARRING,      weight =  350 },
        { item = xi.item.AMORPH_EARRING,    weight =  350 },
        { item = xi.item.LIZARD_EARRING,    weight =  350 },
        { item = xi.item.AQUAN_EARRING,     weight =  350 },
        { item = xi.item.PLANTOID_EARRING,  weight =  350 },
        { item = xi.item.BEAST_EARRING,     weight =  350 },
        { item = xi.item.DEMON_EARRING,     weight =  350 },
        { item = xi.item.DRAGON_EARRING,    weight =  350 },
        { item = xi.item.REFRESH_EARRING,   weight =  350 },
        { item = xi.item.ACCURATE_EARRING,  weight =  350 },
    },
    [99] =
    {
        { item = xi.item.MIRATETES_MEMOIRS, weight = 1000 },
        { item = xi.item.MIGHTY_BOW,        weight =  350 },
        { item = xi.item.MIGHTY_CUDGEL,     weight =  350 },
        { item = xi.item.MIGHTY_POLE,       weight =  350 },
        { item = xi.item.MIGHTY_TALWAR,     weight =  350 },
        { item = xi.item.RAI_KUNIMITSU,     weight =  350 },
        { item = xi.item.NUKEMARU,          weight =  350 },
        { item = xi.item.MIGHTY_PICK,       weight =  350 },
        { item = xi.item.MIGHTY_KNIFE,      weight =  350 },
        { item = xi.item.MIGHTY_ZAGHNAL,    weight =  350 },
        { item = xi.item.MIGHTY_LANCE,      weight =  350 },
        { item = xi.item.MIGHTY_AXE,        weight =  350 },
        { item = xi.item.MIGHTY_PATAS,      weight =  350 },
        { item = xi.item.MIGHTY_SWORD,      weight =  350 },
    },
}
