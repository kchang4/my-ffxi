...
xi.quest.id =
{
    ...
    [xi.quest.area[xi.questLog.SANDORIA]] =
    {
        ...
        A_JOB_FOR_THE_CONSORTIUM        = 67, -- + Converted
        ...
        THE_RIVALRY                     = 75, -- + Converted
        THE_COMPETITION                 = 76, -- + Converted
        ...
        PIEUJES_DECISION                = 89, -- +
        SHARPENING_THE_SWORD            = 90, -- + Converted
        A_BOYS_DREAM                    = 91, -- +
        UNDER_OATH                      = 92,
        THE_HOLY_CREST                  = 93, -- +
        ...
        EXIT_THE_GAMBLER                = 101, -- + Converted
        OLD_WOUNDS                      = 102, -- + Converted
        ESCORT_FOR_HIRE                 = 103,
        A_DISCERNING_EYE                = 104,
        A_TIMELY_VISIT                  = 105, -- + Converted
    ...
    [xi.quest.area[xi.questLog.BASTOK]] =
    {
        ...
        RIVALS                          = 20, -- + Converted
        MOM_THE_ADVENTURER              = 21, -- + Converted, NOTE: This is missable on retail. We've opted not to follow that behaviour. There is a module in /modules/era/lua to restore that behaviour if desired
        ...
        THE_GUSTABERG_TOUR              = 45, -- + Converted
        ...
        OUT_OF_THE_DEPTHS               = 75, -- + Converted
        ALL_BY_MYSELF                   = 76,
        A_QUESTION_OF_FAITH             = 77, -- + Converted
    ...
    [xi.quest.area[xi.questLog.WINDURST]] =
    {
        ...
        ALL_AT_SEA                      = 23, -- + Converted
        THE_ALL_NEW_C_2000              = 24, -- +
        MIHGOS_AMIGO                    = 25, -- + Converted
        ROCK_RACKETEER                  = 26, -- + Converted
        CHOCOBILIOUS                    = 27, -- +
        TEACHERS_PET                    = 28, -- + Converted
        REAP_WHAT_YOU_SOW               = 29, -- +
        GLYPH_HANGER                    = 30, -- + Converted
        THE_FANGED_ONE                  = 31, -- + Converted
        ...
        LEGENDARY_PLAN_B                = 44, -- +
        IN_A_STEW                       = 45, -- + Converted
        LET_SLEEPING_DOGS_LIE           = 46, -- + Converted
        CAN_CARDIANS_CRY                = 47, -- +
        WONDER_WANDS                    = 48, -- +
        HEAVEN_CENT                     = 49,
        ...
        I_CAN_HEAR_A_RAINBOW            = 75, -- + Converted
        ...
        TUNING_IN                       = 90,
        TUNING_OUT                      = 91,
        ONE_GOOD_DEED                   = 92, -- + Converted
        WAKING_DREAMS                   = 93, -- +
        LURE_OF_THE_WILDCAT             = 94, -- + Converted
    ...
    [xi.quest.area[xi.questLog.JEUNO]] =
    {
        ...
        THE_KIND_CARDIAN                = 8,  -- +
        YOUR_CRYSTAL_BALL               = 9,  -- + Converted
        COLLECT_TARUT_CARDS             = 10, -- +
        THE_OLD_MONUMENT                = 11, -- + Converted
        A_MINSTREL_IN_DESPAIR           = 12, -- + Converted
        RUBBISH_DAY                     = 13, -- +
        NEVER_TO_RETURN                 = 14, -- +
        COMMUNITY_SERVICE               = 15, -- +
        COOKS_PRIDE                     = 16, -- +
        TENSHODO_MEMBERSHIP             = 17, -- + Converted
        THE_LOST_CARDIAN                = 18, -- +
        ...
        DUCAL_HOSPITALITY               = 68, -- + Converted
        IN_THE_MOOD_FOR_LOVE            = 69, -- + Converted
        ...
        LURE_OF_THE_WILDCAT             = 90, -- + Converted
    ...
    [xi.quest.area[xi.questLog.OTHER_AREAS]] =
    {
        ...
        UNDER_THE_SEA                   = 17, -- + Converted
        ONLY_THE_BEST                   = 18, -- +
        AN_EXPLORERS_FOOTSTEPS          = 19, -- + Converted
        CARGO                           = 20, -- +
        THE_GIFT                        = 21, -- + Converted
        THE_REAL_GIFT                   = 22, -- + Converted
        THE_RESCUE                      = 23, -- + Converted
        ELDER_MEMORIES                  = 24, -- +
        ...
        GIVE_A_MOOGLE_A_BREAK           = 100, -- + Converted
        THE_MOOGLE_PICNIC               = 101, -- + Converted
        MOOGLES_IN_THE_WILD             = 102, -- + Converted
        MISSIONARY_MOBLIN               = 103, -- + Converted
        FOR_THE_BIRDS                   = 104, -- + Converted
        BETTER_THE_DEMON_YOU_KNOW       = 105, -- + Converted
    ...
    [xi.quest.area[xi.questLog.OUTLANDS]] =
    {
        ...
        YOU_CALL_THAT_A_KNIFE           = 6, -- + Converted
        MISSIONARY_MAN                  = 7,  -- +
        GULLIBLES_TRAVELS               = 8,  -- +
        ...
        LIKE_A_SHINING_SUBLIGAR         = 138, -- + Converted
        LIKE_SHINING_LEGGINGS           = 139, -- + Converted
        ...
        DIVINE_MIGHT                    = 163, -- + Converted
        DIVINE_MIGHT_REPEAT             = 164, -- + Converted
    ...
    [xi.quest.area[xi.questLog.CRYSTAL_WAR]] =
    {
        ...
        THE_SWARM                        = 31,
        ON_SABBATICAL                    = 32, -- + Converted
        DOWNWARD_HELIX                   = 33, -- + Converted
        SEEING_BLOOD_RED                 = 34,
        ...
        SAY_IT_WITH_A_HANDBAG            = 41, -- + TODO: Can be completed, but reward latent not implemented
    ...
    [xi.quest.area[xi.questLog.ABYSSEA]] =
    {
        ...
        A_JOURNEY_BEGINS                = 160, -- + Converted
        THE_TRUTH_BECKONS               = 161, -- + Converted
        DAWN_OF_DEATH                   = 162,
        A_GOLDSTRUCK_GIGAS              = 163, -- + Converted
        TO_PASTE_A_PEISTE               = 164, -- + Converted
        MEGADRILE_MENACE                = 165, -- + Converted
        ...
        SCARS_OF_ABYSSEA                = 175, -- + Converted
        A_BEAKED_BLUSTERER              = 176, -- + Converted
